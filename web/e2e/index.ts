...
const takeScreenshot = async () => {
  ...
  //tests checking the checkboxes one at a time and checks submit button is disabled until all boxes are ticked
  const checkbox1 = (await page.$(".nhsuk-checkboxes__input:first-child"))!;
  await checkbox1.click();
  await page.waitForSelector("button.nhsuk-button--disabled");
